...
var ASM_CONSTS = {
  5001680: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5001741: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5001805: function() {return Module.webglContextAttributes.powerPreference;},  
 5001863: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5001918: function($0) {performance.now = function() { return $0; };},  
 5001966: function($0) {performance.now = function() { return $0; };},  
 5002014: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _SignTx(username, id, data, prompt) {
  ...
  function _Transfer(username, to, amount, memo) {
